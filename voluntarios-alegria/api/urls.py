...
from .views import CampaignListView, ActionListView, DonationListView, ExpenseListView, BeneficiaryListView
...
urlpatterns = [
    ...
    path("export/beneficiarios/", BeneficiaryListView.as_view(), name="export-beneficiarios"),
]
